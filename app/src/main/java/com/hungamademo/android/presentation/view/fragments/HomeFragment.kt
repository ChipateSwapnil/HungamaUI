...
import com.hungamademo.android.domain.model.TabData
import com.hungamademo.android.presentation.adapter.HomeViewPagerAdapter
import com.hungamademo.android.presentation.viewmodel.HomeViewModel
...
//        bottomNavigationSelected?.let { requireContext()?.let { it1 -> ToastUtil.showShortToast(it1, it) } }
    ...
    private fun setViewPager() {
        //set viewpager items
        context?.let { homeViewModel?.getTabItems(bottomNavigationSelected, it) }
        homeViewModel?.tabItemsModel
